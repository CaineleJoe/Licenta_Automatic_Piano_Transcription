...
# --------- CONFIG ---------
MODEL_PATH = "./models/piano_transcription_model_conformer.h5"
WAV_PATH = "C:/Users\Luca\Downloads\song.mp3"
...
if __name__ == "__main__":
    ...
    pred_seq = probs_to_notes(active_notes_probs, attack_probs, threshold=0.5)
